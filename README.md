# KEQ `1.0.2` - Youtube Music Equalizer
...
The extension code is open source and available for any non-commercial or commercial reuse under the MIT License.

The equalizer core and UI are powered by [weq8](https://github.com/teropa/weq8) fork, licensed under the **ISC License**. The license text is available in [THIRD-PARTY-NOTICES.txt](./THIRD-PARTY-NOTICES.txt).